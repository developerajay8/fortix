...
import Mobileimage from "../../../public/image 1 (5).png"
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-lg text-gray-700">
                    Fees starting at <span className="font-semibold">₹499</span>
                  </p>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="text-blue-600 h-5 w-5" />
                  <p className="text-lg text-gray-700">
                    Verified lawyers respond in <span className="font-semibold">15 minutes</span>
                  </p>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="text-blue-600 h-5 w-5" />
                  <p className="text-lg text-gray-700">
                    <span className="font-semibold">100%</span> Private and confidential
                  </p>
                </div>
              </div>
              ...
              <p className="mt-4 text-gray-600">
                <span className="font-semibold">2,500+</span> lawyers online
              </p>
            </div>
